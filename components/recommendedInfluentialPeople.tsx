...
export function RecommendedInfluentialPeople({ person }: InfluentialPeopleProps) {
    return (
        <>
            <div className="p-4 mt-4 ml-2 flex flex-row items-center ">
                <PersonIcon />
                <h1 className={`${ibmPlexMono.className} text-xl ml-2`}>Most Influential</h1>
            </div>
                        ...
                        <Link href={`/influential/${p.id}`} className="flex flex-col">
                            <CardHeader>
                                ...
                                <p className="text-green-700">
                                    {p.occupation}
                                    <p className="mt-4">{p.recommendationsCount} recommendations made.</p>
